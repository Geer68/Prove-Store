...
export function HomePage() {
  ...
  return (
    <>
      ...
      <section className="text-center grid gap-4 mt-16">
        <h2 className="text-2xl sm:text-3xl font-medium">
      ...
      {/* <section className="grid gap-4 mt-10 p-4 bg-black sm:flex sm:items-start">
        <img
          src={portada2}
          alt=""
          className="aspect-square object-cover sm:max-w-96 sm:w-1/4 sm:mx-auto rounded-lg sm:m-0"
        />
