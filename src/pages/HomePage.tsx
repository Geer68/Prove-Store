    ...
    <>
      <section className="grid gap-4 justify-items-center w-full relative">
        ...
        <div className="absolute w-4/6 grid top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white items-center justify-center">
          ...
          <h3 className="text-sm font-light sm:text-5xl max-w-4xl">
          ...
          <Link
            to="/products"
            className="mt-6 border-b border-white w-24 flex text-center justify-between items-center mx-auto"
          >
            Comprar
            <svg
      ...
      <section className="text-center grid gap-4 mt-10">
        <h3 className="text-md font-light sm:text-5xl max-w-4xl">
          Ultimos productos
        </h3>
        <h2 className="text-xl sm:text-5xl max-w-4xl font-medium">
          Comodidad, estilo, minimalismo.
        </h2>
        <Link
          to="/products"
          className="mt-3 border-b border-black w-24 flex text-center justify-between items-center mx-auto"
        >
          Ver Más
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="grid gap-4 mt-10 p-4 bg-orange-100">
        ...
        <h3 className="text-xl sm:text-5xl max-w-4xl font-medium">
          Diseñada para comodidad y estilo en outfits únicos.
        </h3>
        <Link
          to="/products"
          className="mt-3 border-b border-black w-24 flex text-center justify-between"
        >
          Ver Más
          <svg
            xmlns="http://www.w3.org/2000/svg"
