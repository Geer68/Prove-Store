  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <Link
          to={"/products"}
          className="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
        >
